...
for e in emb_amp:
    ...
    for k in start_frame_pos:
        ...
        ---------------'''
        # Y1 に対してゼロを埋め込み
        Y1emb[embedded_freq, :] = e * Y1emb[embedded_freq, :]        # embedded_freqの周波数ビンのみ０に
        Yspec   = Y1emb + Y2spec

        # 音質検査用
        Y1zero[embedded_freq, k:k+3] = e * Y1zero[embedded_freq, k:k+3]
    ...
    for csp1, csp2 in zip(CSP1_log, CSP_emb_wtd_log):
        ...
        csp2_peaks, _ = find_peaks(csp2, height=0.1)
...
ax1.plot(emb_amp, dte_log, label='Distance Estimation Error')
...
ax2.set_xlabel("Embedding amplitude", fontname="Arial")
ax2.set_ylabel("PESQ", fontname="Arial")

lines1, labels1 = ax1.get_legend_handles_labels()
lines2, labels2 = ax2.get_legend_handles_labels()
ax2.legend(lines1+lines2, labels1+labels2, loc='upper left')

plt.savefig('AnpPESQ_m2.svg')
